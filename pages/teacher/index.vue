...
export default {
  ...
  asyncData({ params, error }) {
    ...
    teacherQuery.push(pageInfo);
    return teacherApi.getTeacherList(teacherQuery).then((res) => {
  ...
  methods: {
    gotoPage(page) {
      ...
      this.teacherQuery.push(this.pageInfo);
      teacherApi.getTeacherList(this.teacherQuery).then((response) => {
