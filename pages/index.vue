        ...
        <section class="container">
          ...
          <div>
            <article class="i-teacher-list">
              <ul class="of">
                <li v-for="eduTeacher in eduTeacherList" :key="eduTeacher">
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/teacher/1" :title="eduTeacher.name">
                        <img :alt="eduTeacher.name" :src="eduTeacher.avatar">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/teacher/1" :title="eduTeacher.name" class="fsize18 c-666">{{ eduTeacher.name }}</a>
                    </div>
                    <div class="hLh30 txtOf tac">
                      <span class="fsize14 c-999">{{ eduTeacher.career }}</span>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getTeacherAndCourseList(){
      ...
      .then(res => {
        this.eduTeacherList = res.data.data.eduTeacherList;
